...
private Integer id;
    ...
    private Integer novilho1324janmar;
    private Integer novilho1324abrjun;
    private Integer novilho1324julset;
    private Integer novilho1324outdez;    
    private Integer novilha1324janmar;
    private Integer novilha1324abrjun;
    private Integer novilha1324julset;
    private Integer novilha1324outdez;    
    private Integer novilho2536janmar;
    private Integer novilho2536abrjun;
    private Integer novilho2536julset;
    private Integer novilho2536outdez;    
    private Integer novilha2536janmar;
    private Integer novilha2536abrjun;
    private Integer novilha2536julset;
    private Integer novilha2536outdez;    
    ...
    public Integer getNovilho1324janmar() {
        return novilho1324janmar;
    }
    public void setNovilho1324janmar(Integer novilho1324janmar) {
        this.novilho1324janmar = novilho1324janmar;
    }
    public Integer getNovilho1324abrjun() {
        return novilho1324abrjun;
    }
    public void setNovilho1324abrjun(Integer novilho1324abrjun) {
        this.novilho1324abrjun = novilho1324abrjun;
    }
    public Integer getNovilho1324julset() {
        return novilho1324julset;
    }
    public void setNovilho1324julset(Integer novilho1324julset) {
        this.novilho1324julset = novilho1324julset;
    }
    public Integer getNovilho1324outdez() {
        return novilho1324outdez;
    }
    public void setNovilho1324outdez(Integer novilho1324outdez) {
        this.novilho1324outdez = novilho1324outdez;
    }
    public Integer getNovilha1324janmar() {
        return novilha1324janmar;
    }
    public void setNovilha1324janmar(Integer novilha1324janmar) {
        this.novilha1324janmar = novilha1324janmar;
    }
    public Integer getNovilha1324abrjun() {
        return novilha1324abrjun;
    }
    public void setNovilha1324abrjun(Integer novilha1324abrjun) {
        this.novilha1324abrjun = novilha1324abrjun;
    }
    public Integer getNovilha1324julset() {
        return novilha1324julset;
    }
    public void setNovilha1324julset(Integer novilha1324julset) {
        this.novilha1324julset = novilha1324julset;
    }
    public Integer getNovilha1324outdez() {
        return novilha1324outdez;
    }
    public void setNovilha1324outdez(Integer novilha1324outdez) {
        this.novilha1324outdez = novilha1324outdez;
    }
    public Integer getNovilho2536janmar() {
        return novilho2536janmar;
    }
    public void setNovilho2536janmar(Integer novilho2536janmar) {
        this.novilho2536janmar = novilho2536janmar;
    }
    public Integer getNovilho2536abrjun() {
        return novilho2536abrjun;
    }
    public void setNovilho2536abrjun(Integer novilho2536abrjun) {
        this.novilho2536abrjun = novilho2536abrjun;
    }
    public Integer getNovilho2536julset() {
        return novilho2536julset;
    }
    public void setNovilho2536julset(Integer novilho2536julset) {
        this.novilho2536julset = novilho2536julset;
    }
    public Integer getNovilho2536outdez() {
        return novilho2536outdez;
    }
    public void setNovilho2536outdez(Integer novilho2536outdez) {
        this.novilho2536outdez = novilho2536outdez;
    }
    public Integer getNovilha2536janmar() {
        return novilha2536janmar;
    }
    public void setNovilha2536janmar(Integer novilha2536janmar) {
        this.novilha2536janmar = novilha2536janmar;
    }
    public Integer getNovilha2536abrjun() {
        return novilha2536abrjun;
    }
    public void setNovilha2536abrjun(Integer novilha2536abrjun) {
        this.novilha2536abrjun = novilha2536abrjun;
    }
    public Integer getNovilha2536julset() {
        return novilha2536julset;
    }
    public void setNovilha2536julset(Integer novilha2536julset) {
        this.novilha2536julset = novilha2536julset;
    }
    public Integer getNovilha2536outdez() {
        return novilha2536outdez;
    }
    public void setNovilha2536outdez(Integer novilha2536outdez) {
        this.novilha2536outdez = novilha2536outdez;
    }
