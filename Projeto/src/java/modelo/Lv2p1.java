...
public class Lv2p1 {
    ...
    private Double outrasplantadas;
    ...
    public Double getOutrasplantadas() {
        return outrasplantadas;
    }
    public void setOutrasplantadas(Double outrasplantadas) {
        this.outrasplantadas = outrasplantadas;
    }
