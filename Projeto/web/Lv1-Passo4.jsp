                ...
                <aside class="span6">
                    ...
                    <form name="Passo4" action="Lv1-Saida.jsp" class="form-horizontal" method ="post" onSubmit="return passo4();">
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="number" id="medicamentos" name="medicamentos" value="<%=medicamentos%>" >
                                <span>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="number" id="maodeobra" name="maodeobra" value="<%=maodeobra%>" >
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="number" id="maquinas" name="maquinas" value="<%=maquinas%>" >
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <br/>
                                <input type="number" id="dispesas" name="dispesas" value="<%=dispesas%>" >
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="number" id="outros" name="outros" value="<%=outros%>">
